...
export const analytics = {
  productView: (produto) => trackEvent("product_view", {
    sku: produto.sku_codigo, nome: produto.nome_peca,
    categoria: produto.relacionamento_categoria, marca: produto.relacionamento_marca,
    preco: produto.preco_base_atacado || 0
  }),
  productAddToCart: (produto, quantidade) => trackEvent("add_to_cart", {
    sku: produto.sku_codigo, nome: produto.nome_peca, quantidade,
    categoria: produto.relacionamento_categoria, marca: produto.relacionamento_marca
  }),
  ...
  search: (query, filters = {}) => trackEvent("search", {
    query, categoria: filters.categoria || null, marca: filters.marca || null, tipo: filters.tipo || null
  }),
  quoteSubmit: (itens, total) => trackEvent("quote_submit", {
    num_itens: itens.length, total_quantidade: total, via: "whatsapp"
  }),
...
export const trackEvent as default;