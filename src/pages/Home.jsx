    ...
    <div className="mm-bg min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center" style={{ zIndex: 2 }}>
          ...
          <div>
            ...
            <h1 className="mb-4 leading-tight" style={{ fontFamily: "'Space Mono', monospace" }}>
              <span className="block text-4xl md:text-5xl font-bold mm-text-metal">ESPECIALISTAS</span>
              <span className="block text-4xl md:text-5xl font-bold mm-text-metal">EM EQUIPAMENTOS</span>
              <span className="block text-3xl md:text-4xl font-bold mm-text-orange mt-1">QUE TRABALHAM</span>
              <span className="block text-3xl md:text-4xl font-bold mm-text-orange">COM VOCÊ.</span>
            </h1>

            <p className="mb-8" style={{ color: "#9CA3AF", fontSize: "17px", fontWeight: 400, maxWidth: 440, lineHeight: 1.75 }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                <Select value={selectedMarca} onValueChange={setSelectedMarca}>
                  <SelectTrigger className="h-10 text-sm font-mono-tech" style={{
                    ...
                    color: selectedMarca ? "#F3F4F6" : "#6B7280",
                    borderRadius: "2px",
                  }}>
                ...
                <Select value={selectedCategoria} onValueChange={setSelectedCategoria}>
                  <SelectTrigger className="h-10 text-sm font-mono-tech" style={{
                    background: "rgba(255,255,255,0.05)",
                    border: "1px solid rgba(29,78,216,0.35)",
                    color: selectedCategoria ? "#F3F4F6" : "#6B7280",
                    borderRadius: "2px",
                  }}>
            ...
            <Link to={createPageUrl("Catalogo")}>
              <button
                className="mm-btn-tactile flex items-center gap-2 px-6 h-11 font-semibold text-sm font-mono-tech"
                style={{
      ...
      <section className="py-16 px-4 relative overflow-hidden" style={{ background: "linear-gradient(145deg, #0A0A0C, #15151A)" }}>
        ...
        <div className="relative max-w-2xl mx-auto text-center" style={{ zIndex: 2 }}>
          <h2 className="text-2xl md:text-3xl font-bold mb-4 font-mono-tech" style={{ color: "#F3F4F6" }}>
