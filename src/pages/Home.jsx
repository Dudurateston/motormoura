    ...
    <>
      ...
      <div style={{ background: "#F8F9FA" }}>
        ...
        <section style={{ background: '#07090e', display: 'flex', minHeight: 'clamp(480px, 55vw, 680px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ width: 'clamp(280px, 33%, 380px)', flexShrink: 0, borderLeft: '1px solid rgba(255,255,255,.07)', display: 'flex', flexDirection: 'column', zIndex: 2 }} className="mr-4 hidden lg:flex">
            {/* Brands */}
